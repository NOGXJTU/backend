...
public class testDemoA79 {
    ...
    //testA79_1 admin delete  knowledge information
    @Test
    public void testA79_1() throws Exception{
        System.out.println("deleteknowledgeInfo1验证接口测试");
//        try {
//            mockMvc.perform(delete("/point/point{id}?id=""")
...
//            e.printStackTrace();
//        }
        System.out.println("deleteknowledgeInfo1验证接口测试完毕");
    }

    //testA79_2 admin delete inexisted knowledge information
    @Test
    public void testA79_2() throws Exception{

        System.out.println("deleteknowledgeInfo2验证接口测试");
//        try {
//            mockMvc.perform(delete("/point/point/{id}?id=""")
//                    .contentType(contentType)
//                    .session(session))
...
//            e.printStackTrace();
//        }
        System.out.println("deleteknowledgeInfo2验证接口测试完毕");
    }
