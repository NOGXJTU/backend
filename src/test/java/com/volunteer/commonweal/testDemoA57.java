...
public class testDemoA57 {
    ...
    //testA57 leader get all activities application
    @Test
    public void testA57() throws Exception{
        ...
        System.out.println("getAllApp验证接口测试");

        OnlyIdData OID=new OnlyIdData();
        OID.activityId="5bf15e0dccf2b97bc37e303c";

        try {
            mockMvc.perform(post("/application/getAllApp")
        ...
        System.out.println("getAllApp验证接口测试完毕");
