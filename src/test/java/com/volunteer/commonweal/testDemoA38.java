...
public class testDemoA38 {
    ...
    //testA38 team leader removes some NOT team members from his/her activity
    @Test
    public void testA38() throws Exception{
        ...
        System.out.println("removeActivityMember4验证接口测试");
        try {
        ...
        System.out.println("removeActivityMember4验证接口测试完毕");
    }
