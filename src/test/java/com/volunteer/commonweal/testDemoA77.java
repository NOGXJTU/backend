...
public class testDemoA77 {
    ...
    //testA77_1 admin get  knowledge information
    @Test
    public void testA77_1() throws Exception{
        System.out.println("getknowledgeInfo1验证接口测试");
//        try {
//            mockMvc.perform(get("/point/point{id}?id=""")
...
//            e.printStackTrace();
//        }
        System.out.println("getknowledgeInfo1验证接口测试完毕");
    }

    //testA77_2 admin get inexisted knowledge information
    @Test
    public void testA77_2() throws Exception{

        System.out.println("getknowledgeInfo2验证接口测试");
//        try {
//            mockMvc.perform(get("/point/point/{id}?id=""")
//                    .contentType(contentType)
//                    .session(session))
...
//            e.printStackTrace();
//        }
        System.out.println("getknowledgeInfo2验证接口测试完毕");
    }
