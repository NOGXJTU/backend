...
public class testDemoA54 {
    ...
    public void testA56() throws Exception {
        ...
        System.out.println("application/confirm验证接口测试");
        try {
            mockMvc.perform(post("/application/confirm")
        ...
        System.out.println("application/confirm验证接口测试完毕");
    }
