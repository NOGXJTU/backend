...
public class testDemoA34 {
    ...
    //testA29 team leader remove inexistent member
    @Test
    public void testA33() throws Exception{
        IdAndUserIdData IAUD = new IdAndUserIdData();
        IAUD.activityId="5bf02946ccf2b97bc37e3037";
        IAUD.userId="5bf1804cccf2b97bc37e3040";
        System.out.println("removeinexistentMember验证接口测试");
        try {
            mockMvc.perform(post("/activity/removeMember")
        ...
        System.out.println("removeinexistentMember验证接口测试完毕");
    }
    @After
