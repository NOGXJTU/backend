...
public class testDemoA35 {
    ...
    //testA29 team leader remove himself
    @Test
    public void testA35() throws Exception{
        IdAndUserIdData IAUD = new IdAndUserIdData();
        IAUD.activityId="5bf02946ccf2b97bc37e3037";
        IAUD.userId="5bed36d5ccf2b952894b0081";
        System.out.println("removehimself验证接口测试");
        try {
        ...
        System.out.println("removehimself验证接口测试完毕");
    }
    @After
