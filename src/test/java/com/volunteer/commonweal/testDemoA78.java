...
public class testDemoA78 {
    ...
    //testA78 admin get all knowledge information
    @Test
    public void testA78() throws Exception{
        System.out.println("getallknowledge Info1验证接口测试");
        try {
            mockMvc.perform(get("/point/point")
        ...
        System.out.println("getallknowledge Info1验证接口测试完毕");
    }
