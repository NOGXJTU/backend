...
public class testDemoA73 {
    ...
    //testA73 admin get all major information
    @Test
    public void testA73() throws Exception{
        System.out.println("getallMajorInfo1验证接口测试");
        try {
            mockMvc.perform(get("/subject/subject")
        ...
        System.out.println("getallMajorInfo1验证接口测试完毕");
    }
