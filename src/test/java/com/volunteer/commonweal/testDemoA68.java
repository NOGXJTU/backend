...
public class testDemoA68 {
    ...
    //testA68 admin all  college information
    @Test
    public void testA68() throws Exception{
        System.out.println("getallCollegeInfo1验证接口测试");
        try {
            mockMvc.perform(get("/school/school")
        ...
        System.out.println("getallCollegeInfo1验证接口测试完毕");
    }
