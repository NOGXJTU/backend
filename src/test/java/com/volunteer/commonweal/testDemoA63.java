...
public class testDemoA63 {
    ...
    //testA63 leader agree application
    @Test
    public void testA63() throws Exception{
        ...
        System.out.println("agree验证接口测试");
        try {
            mockMvc.perform(post("/organization/join/agree")
        ...
        System.out.println("agree验证接口测试完毕");
