...
public class testDemoA69 {
    ...
    //testA69_1 admin delete  college information
    @Test
    public void testA69_1() throws Exception{
        System.out.println("deleteCollegeInfo1验证接口测试");
//        try {
//            mockMvc.perform(delete("/school/school/{id}?id=""")
...
//            e.printStackTrace();
//        }
        System.out.println("deleteCollegeInfo1验证接口测试完毕");
    }

    //testA69_2 admin delete inexisted  college information
    @Test
    public void testA69_2() throws Exception{

        System.out.println("deleteCollegeInfo2验证接口测试");
//        try {
//            mockMvc.perform(delete("/school/school/{id}?id=""")
//                    .contentType(contentType)
//                    .session(session))
