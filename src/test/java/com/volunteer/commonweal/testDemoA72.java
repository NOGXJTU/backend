...
public class testDemoA72 {
    ...
    //testA72_1 admin get  major information
    @Test
    public void testA72_1() throws Exception{
        System.out.println("getMajorInfo1验证接口测试");
//        try {
//            mockMvc.perform(get("/subject/subject/{id}?id=""")
...
//            e.printStackTrace();
//        }
        System.out.println("getMajorInfo1验证接口测试完毕");
    }

    //testA70_2 admin get inexisted Major information
    @Test
    public void testA70_2() throws Exception{

        System.out.println("getMajorInfo2验证接口测试");
//        try {
//            mockMvc.perform(get("/subject/subject/{id}?id=""")
//                    .contentType(contentType)
//                    .session(session))
...
//            e.printStackTrace();
//        }
        System.out.println("getMajorInfo2验证接口测试完毕");
    }
