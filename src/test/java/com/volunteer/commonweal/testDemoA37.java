...
public class testDemoA37 {
    ...
    //testA37 team leader removes some mix team members from his/her activity
    @Test
    public void testA37() throws Exception{
        ...
        IAULD.activityId = "bf024b1ccf2b97bc37e3035";
        IAULD.userIdGroup = userIdGroup;
        System.out.println("removeActivityMember3验证接口测试");
        try {
        ...
        System.out.println("removeActivityMember3验证接口测试完毕");
    }
