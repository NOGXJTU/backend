...
public class testDemoA67 {
    ...
    //testA67_1 admin get  college information
    @Test
    public void testA67_1() throws Exception{
        System.out.println("getCollegeInfo1验证接口测试");
//        try {
//            mockMvc.perform(get("/school/school/{id}?id=""")
...
//            e.printStackTrace();
//        }
        System.out.println("getCollegeInfo1验证接口测试完毕");
    }

    //testA67_2 admin get inexisted  college information
    @Test
    public void testA67_2() throws Exception{

        System.out.println("getCollegeInfo2验证接口测试");
//        try {
//            mockMvc.perform(get("/school/school/{id}?id=""")
//                    .contentType(contentType)
//                    .session(session))
